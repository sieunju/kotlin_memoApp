...
open class RectDrawer internal constructor(indicatorOptions: IndicatorOptions)
    : BaseDrawer(indicatorOptions), KoinComponent {
    ...
    private fun drawInequalitySlider(canvas: Canvas, pageSize: Int) {
        ...
        for (i in 0 until pageSize) {
            ...
            mPaint.color = if (i == mIndicatorOptions.currentPosition) mIndicatorOptions.checkedSliderColor else mIndicatorOptions.normalSliderColor
    ...
    private fun getCoordinateX(indicatorOptions: IndicatorOptions, maxDiameter: Float, index: Int): Float {
